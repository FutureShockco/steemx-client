                            ...
                            <BCard no-body class="mb-0 border-0 shadow-none mb-0">
                                <BCardBody class="p-sm-5 m-lg-4">
                                    <div class="text-center mt-2">
                                        ...
                                        <p class="text-muted mb-4">Reset password with SteemX</p>
                                        <div class="pb-4">
                                    ...
                                    <div class="p-2">
                                        <form @submit.prevent="tryToReset">
                                            <div class="mb-4">
                                                ...
                                                <input type="email" class="form-control bg-light border-light password-input" id="email" placeholder="Enter email or username" v-model="email" :class="{ 'is-invalid': submitted && v$.email.$errors }" required >
                                            </div>
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">Wait, I remember my password... <router-link to="/login" class="fw-semibold text-primary text-decoration-underline"> Click here </router-link> </p>
                                    </div>
                                </BCardBody>
                            </BCard>
                        </BCol>
