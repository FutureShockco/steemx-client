                                            ...
                                            <form class="needs-validation" novalidate action="#">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control bg-light border-light"
                                                        id="username" placeholder="Enter username" v-model="user.username"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password"
                                                            class="form-control password-input bg-light border-light pe-5"
                                                ...
                                                <div class="mb-4">
                                                    <p class="mb-0 fs-sm text-muted fst-italic">By registering you agree to
                                                        the SteemX <router-link to="/pages/term-conditions"
                                                            class="text-primary text-decoration-underline fst-normal fw-medium">Terms
                                                            of Use</router-link></p>
                                                </div>
