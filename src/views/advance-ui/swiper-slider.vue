...
export default {
  data() {
    return {
      ...
      coverflowModules: [EffectCoverflow, Autoplay, Pagination],
  ...
  <Layout>
    ...
    <BRow>
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Default Swiper</BCardTitle>
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Navigation & Pagination Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Pagination Dynamic Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Pagination Fraction Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Pagination Custom Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Pagination Progress Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Scrollbar Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Vertical Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Mousewheel Control Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Effect Fade Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Effect Creative Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol xl="4" lg="6">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Effect Flip Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Effect Coverflow Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
      ...
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Responsive Breakpoints Swiper</BCardTitle>
            <p class="text-muted mb-0">
              Use
