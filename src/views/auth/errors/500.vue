                                    ...
                                    <BCardBody class="py-5 d-flex justify-content-between flex-column h-100 position-relative gap-4">
                                        ...
                                        <div class="text-center">
                                            <p class="text-white text-opacity-75 mb-0 mt-3">
                                                &copy;
                                                {{new Date().getFullYear()}} SteemX. Crafted with <i class="bi bi-heart-fill text-danger"></i>
                                                by <BLink href="#!" class="text-white">Themesbrand</BLink>
                                            </p>
                                        </div>
                                    </BCardBody>
                                </BCard>
                                ...
                                <BCard no-body class="mb-0 border-0 shadow-none mb-0">
                                    <BCardBody class="p-sm-5 m-lg-4">
                                        <div class="error-img text-center px-5">
                                            <img src="@/assets/images/auth/500.png" class="img-fluid" alt="">
                                        </div>
                                        <div class="mt-4 text-center pt-4">
                                            <div class="position-relative">
                                                <h4 class="fs-2xl error-subtitle text-uppercase mb-0">Internal Server Error
                                                </h4>
                                                <p class="fs-base text-muted mt-3">It will be as simple as Occidental in
                                                fact,
                                                it will Occidental to an English person</p>
                                            <div class="mt-4">
                                                <router-link to="/" class="btn btn-primary"><i
                                                        class="bi bi-house me-1"></i>Back to home</router-link>
                                            </div>
                                        </div>
                                    </div>
                                </BCardBody>
