                                    ...
                                    <BCardBody class="py-5 d-flex justify-content-between flex-column h-100 position-relative gap-4">
                                        ...
                                        <div class="text-center">
                                            <p class="text-white text-opacity-75 mb-0 mt-3">
                                                &copy; {{new Date().getFullYear()}} SteemX. Crafted with <i class="bi bi-heart-fill text-danger"></i> by <BLink href="#!" class="text-white">Themesbrand</BLink>
                                            </p>
                                        </div>
                                    </BCardBody>
                                </BCard>
                            ...
                            <BCol xxl="6" class="mx-auto">
                                <BCard no-body class="mb-0 border-0 shadow-none mb-0">
                                    <BCardBody class="p-sm-5 m-lg-4">
                                        <div class="display-5 text-center text-secondary">
                                            <i class="bi bi-box-arrow-right"></i>
                                        </div>
                                        <div class="mt-4 pt-2 text-center">
                                            <h5 class="fs-2xl">You are Logged Out</h5>
                                            <p class="text-muted">Thank you for using <span class="fw-semibold">steemx</span> admin template</p>
                                            <div class="mt-4">
                                                <router-link to="/auth/signin" class="btn btn-primary w-100">Sign In</router-link>
                                            </div>
                                        </div>
                                    </BCardBody>
                                </BCard>
