      ...
      <BRow class="justify-content-center">
        <BCol lg="11">
          <BCard no-body class="mb-0 p-2">
            <BRow class="g-0">
              <BCol xxl="5">
                <BCard no-body class="auth-card h-100 border-0 shadow-none d-none d-sm-block overflow-hidden mb-0">
                  ...
                  <BCardBody class="py-5 d-flex justify-content-between flex-column h-100 position-relative gap-4">
                    ...
                    <div class="text-center">
                      <p class="text-white text-opacity-75 mb-0 mt-3">
                        &copy;
                        {{new Date().getFullYear()}} SteemX. Crafted with <i class="bi bi-heart-fill text-danger"></i> by <BLink href="#!" class="text-white">Themesbrand</BLink>
                      </p>
                    </div>
                  </BCardBody>
                </BCard>
                ...
                <BCard no-body class="mb-0 border-0 shadow-none mb-0">
                  <BCardBody class="p-sm-5 m-lg-4">
                      ...
                      <form action="#" id="auth-form">
                        <div class="mb-3">
                          ...
                          <div class="position-relative auth-pass-inputgroup">
                            <input :type="togglePassword ? 'text' : 'password'" class="form-control pe-5 password-input" onpaste="return false" placeholder="Enter password" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                            <b-button variant="link" class="position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon" @click="togglePassword = !togglePassword"><i class="ri-eye-fill align-middle"></i></b-button>
                          </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="position-relative auth-pass-inputgroup mb-3">
                            <input :type="confirmPassword ? 'text' : 'password'" class="form-control pe-5 password-input" onpaste="return false" placeholder="Confirm password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="confirm-password-input" required>
                            <b-button variant="link" class="position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="confirm-password-input" @click="confirmPassword = !confirmPassword"><i class="ri-eye-fill align-middle"></i></b-button>
                          </div>
                        </div>
                    ...
                    <div class="mt-4 text-center">
                      <p class="mb-0">Wait, I remember my password... <router-link to="/auth/signin" class="fw-semibold text-primary text-decoration-underline"> Click here </router-link>
                      </p>
                    </div>
                  </BCardBody>
                </BCard>
