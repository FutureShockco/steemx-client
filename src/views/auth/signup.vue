                                    ...
                                    <BCardBody class="py-5 d-flex justify-content-between flex-column h-100 position-relative gap-4">
                                        ...
                                        <div class="text-center">
                                            <p class="text-white text-opacity-75 mb-0 mt-3">
                                                &copy;
                                                {{new Date().getFullYear()}} SteemX. Crafted with <i class="bi bi-heart-fill text-danger"></i> by <BLink href="#!" class="text-white">Futureshock</BLink>
                                            </p>
                                        </div>
                                    </BCardBody>
                                </BCard>
                                ...
                                <BCard no-body class="mb-0 border-0 shadow-none mb-0">
                                    <BCardBody class="p-sm-5 m-lg-4">
                                        <div class="text-center mt-2">
                                            ...
                                            <p class="text-muted">Get your free SteemX account now</p>
                                        </div>
                                        <div class="p-2 mt-5">
                                            <form class="needs-validation" novalidate action="#">
                                                ...
                                                <div class="mb-4">
                                                    <p class="mb-0 fs-sm text-muted fst-italic">By registering you agree to the SteemX <router-link to="/pages/term-conditions" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</router-link></p>
                                                </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">Already have an account ? <router-link to="/auth/signin" class="fw-semibold text-primary text-decoration-underline"> Signin </router-link> </p>
                                        </div>
                                    </BCardBody>
                                </BCard>
                            </BCol>
