                                ...
                                <BCard no-body class="mb-0 border-0 shadow-none mb-0">
                                    <BCardBody class="p-sm-5 m-lg-4">
                                        <div class="avatar-lg mx-auto mt-2">
                                            <div class="avatar-title bg-body-secondary text-success display-5 rounded-circle">
                                        ...
                                        <div class="mt-4 text-center">
                                            ...
                                            <div class="mt-4">
                                                <router-link to="/auth/signin" class="btn btn-primary w-100">Back to Dashboard</router-link>
                                            </div>
                                        </div>
                                    </BCardBody>
                                </BCard>
