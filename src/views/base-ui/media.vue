  ...
  <Layout>
    <div class="page-title-box">
      <BRow class="align-items-center">
        <BCol md="5">
          <PageHeader title="Media Object" pagetitle="Bootstrap UI" />
        </BCol>
    ...
    <BRow>
      <BCol xxl="12">
        <BCard no-body>
          <CardHeader title="Examples" content="Use few flex utilities that allow even more flexibility and customization than
          before." />
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="examplesPreview" role="tabpanel" aria-labelledby="examplesPreview-tab"
              tabindex="0">
              <div>
            ...
            <div class="tab-pane" id="examplesCode" role="tabpanel" aria-labelledby="examplesCode-tab" tabindex="0">
...
&lt;/div&gt;</code></pre>
      ...
      <BCol xxl="12">
        <BCard no-body>
          <CardHeader title="Nesting Example" content="Media objects can be infinitely nested, though we suggest you stop at some point.
          Place nested <code>d-flex align-items-start</code> within the <code>flex-grow-1</code> of a parent media
          object." />
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="nestingExamplesPreview" role="tabpanel"
              aria-labelledby="nestingExamplesPreview-tab" tabindex="0">
              <div>
                <div class="d-flex align-items-start text-muted mb-4">
                  <div class="flex-shrink-0 me-3">
                    <img src="@/assets/images/users/avatar-2.jpg" class="avatar-sm rounded" alt="...">
            ...
            <div class="tab-pane" id="nestingExamplesCode" role="tabpanel" aria-labelledby="nestingExamplesCode-tab"
              tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <CardHeader title="Media Alignment" content="The images or other media can be aligned top, middle, or bottom. The default is
          top aligned." />
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="MediaAlignmentPreview" role="tabpanel"
              aria-labelledby="MediaAlignmentPreview-tab" tabindex="0">
              <div>
                <div class="d-flex align-items-start text-muted mb-4">
                  <div class="flex-shrink-0 me-3">
                    <img src="@/assets/images/users/avatar-2.jpg" class="avatar-sm rounded" alt="...">
            ...
            <div class="tab-pane" id="MediaAlignmentCode" role="tabpanel" aria-labelledby="MediaAlignmentCode-tab"
              tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
