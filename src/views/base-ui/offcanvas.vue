  ...
  <Layout>
    <div class="page-title-box">
      <BRow class="align-items-center">
        <BCol md="5">
          <PageHeader title="Offcanvas" pagetitle="Bootstrap UI" />
        </BCol>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <CardHeader title="Default Offcanvas" content="Use the <code>offcanvas</code> class to set a default offcanvas." />
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="defaultOffcanvasPreview" role="tabpanel"
              ...
              <BOffcanvas v-model="defaultOffcanvas" title="Recent Activity"
                  ...
                  <div class="acitivity-timeline p-4">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted mb-2">added a new member to SteemX dashboard</p>
                ...
                <template #footer>
                  <BLink href="javascript:void(0);" class="link-success">View All Activity <i class="ri-arrow-right-s-line align-middle ms-1"></i></BLink>
                </template>
              </BOffcanvas>
            </div>
            <div class="tab-pane" id="defaultOffcanvasCode" role="tabpanel" aria-labelledby="defaultOffcanvasCode-tab"
              tabindex="0">
...
&lt;/div&gt;</code></pre>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <CardHeader title="Placement Offcanvas" content="Use <code>offcanvas-top</code>, <code>offcanvas-end</code>,
            <code>offcanvas-bottom</code>, or <code>offcanvas-start</code> to offcanvas class to set different
            Offcanvas Placement." />
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="placementOffcanvasPreview" role="tabpanel"
              ...
              <div>
                ...
                <!-- right offcanvas -->
                <BOffcanvas v-model="rightOffcanvas" placement="end" title="Recent Acitivity" header-class="border-bottom" body-class="p-0 overflow-hidden" footer-class="border-top p-3 text-center">
                  <div data-simplebar style="height: calc(100vh - 112px);">
                    <div class="acitivity-timeline p-4">
                      <div class="acitivity-item d-flex">
                        <div class="flex-shrink-0">
                ...
                <!-- left offcanvas -->
                <BOffcanvas v-model="leftOffcanvas" placement="start" title="Recent Acitivity" header-class="border-bottom" body-class="p-0 overflow-hidden" footer-class="border-top p-3 text-center">
                  <div data-simplebar style="height: calc(100vh - 112px);">
                    <div class="acitivity-timeline p-4">
                      <div class="acitivity-item d-flex">
                        <div class="flex-shrink-0">
            ...
            <div class="tab-pane" id="placementOffcanvasCode" role="tabpanel" aria-labelledby="placementOffcanvasCode-tab"
              tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <CardHeader title="Backdrop Offcanvas" content="Here are the example of offcanvas with scrolling active and backdrop visible." />
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="backdropOffcanvasPreview" role="tabpanel"
              ...
              <div>
                ...
                <BOffcanvas v-model="backdropOff" title="Customer Acitivity" :backdrop="backdrop" header-class="border-bottom" body-class="p-0 overflow-hidden" footer-class="border-top p-3 text-center">
                  <div data-simplebar style="height: calc(100vh - 112px);">
                    <div class="acitivity-timeline p-4">
                      <div class="acitivity-item d-flex">
                        <div class="flex-shrink-0">
            ...
            <div class="tab-pane" id="backdropOffcanvasCode" role="tabpanel" aria-labelledby="backdropOffcanvasCode-tab"
              tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
