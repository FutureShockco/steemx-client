  ...
  <Layout>
    <div class="page-title-box">
      <BRow class="align-items-center">
        <BCol md="5">
          <PageHeader title="Utilities" pagetitle="Bootstrap UI" />
        </BCol>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Borders</BCardTitle>
            <p class="text-muted mb-0">Use border utilities to add or remove an element’s borders. Choose from all borders
              or one at a time.</p>
          </BCardHeader>
          <BCard>
            <div>
                ...
                <BCol xxl="5">
                  <div>
                    ...
                    <div class="d-flex align-items-start flex-wrap gap-4">
                      <div class="text-center">
                        <div
                          class="border border-primary border-dotted border-bottom-lg-0 avatar-md bg-light mx-auto mb-1">
                        </div>
                        <p><code>.border-bottom-lg-0</code></p>
                      </div>
                      <div class="text-center">
                        <div
                          class="border border-secondary border-end-lg-0 border-dashed avatar-md bg-light mx-auto mb-1">
                        </div>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Border Radius</BCardTitle>
            <p class="text-muted mb-0">Use below-mentioned class to an element to easily round its corners.</p>
          </BCardHeader>
          <BCard>
            <div>
              <div class="d-flex align-items-start flex-wrap gap-4">
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Display Property</BCardTitle>
            <p class="text-muted mb-0">Use below-mentioned class to an element to display the value of components and more
              with our display utilities.</p>
          </BCardHeader>
          <BCard>
            <BRow>
              <BCol lg="6">
            ...
            <div class="mt-4 mb-1">
              ...
              <p class="text-muted">Change the display value of elements when printing with our print display utility
                classes.</p>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
            <BCardTitle class="mb-1">Custom Class</BCardTitle>
            <p class="text-muted mb-0">Use the below-mentioned class to an element to custom display the value of
        ...
        <BCard no-body>
          <BCardHeader class="d-flex">
            <div class="flex-grow-1">
              <BCardTitle class="mb-1">Stacks - Vertical</BCardTitle>
              <p class="text-muted mb-0">Use <code>vstack</code> class to create vertical layouts. Stacked items are
            ...
            <div class="flex-shrink-0 mt-3 mt-md-0">
              <div class="nav nav-pills code-menu bg-light p-1 rounded" role="tablist">
                <button class="nav-link active" id="stacksVerticalPreview-tab" data-bs-toggle="pill"
                  data-bs-target="#stacksVerticalPreview" type="button" role="tab" aria-controls="stacksVerticalPreview"
                  aria-selected="true">Preview</button>
                <button class="nav-link" id="stacksVerticalCode-tab" data-bs-toggle="pill"
                  data-bs-target="#stacksVerticalCode" type="button" role="tab" aria-controls="stacksVerticalCode"
                  aria-selected="false">HTML</button>
              </div>
            </div>
          </BCardHeader>
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="stacksVerticalPreview" role="tabpanel"
              aria-labelledby="stacksVerticalPreview-tab" tabindex="0">
              <div>
            ...
            <div class="tab-pane" id="stacksVerticalCode" role="tabpanel" aria-labelledby="stacksVerticalCode-tab"
              tabindex="0">
...
&lt;/div&gt;</code></pre>
      ...
      <BCol xxl="6">
        <BCard no-body>
          <CardHeader title="Stacks - Horizontal" content="Use <code>hstack</code> class to create horizontal layouts. Stacked items are full-width by default. Use <code>gap-</code> class with variation to add space between items." />  
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="stacksHorizontalPreview" role="tabpanel"
              aria-labelledby="stacksHorizontalPreview-tab" tabindex="0">
              <div>
            ...
            <div class="tab-pane" id="stacksHorizontalCode" role="tabpanel" aria-labelledby="stacksHorizontalCode-tab"
              tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <BRow>
      <BCol xxl="12">
        <BCard no-body>
          <CardHeader title="Object Fit" content="Use the object fit utilities to modify how the content of a replaced element, such as an <code>&lt;img&gt;</code> or <code>&lt;video&gt;</code>, should be resized to fit its container." />  
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="objectFitPreview" role="tabpanel" aria-labelledby="objectFitPreview-tab"
              tabindex="0">
              <BRow g="4">
                <BCol md="6" class="col-lg">
                  <div class="text-center">
                    <img src="@/assets/images/small/img-3.jpg" alt="" height="230" width="200"
                ...
                <BCol md="6" class="col-lg">
                  <div class="text-center">
                    <img src="@/assets/images/small/img-3.jpg" alt="" height="230" width="200"
                      class="rounded object-fit-fill border">
                ...
                <BCol md="6" class="col-lg">
                  <div class="text-center">
                    <img src="@/assets/images/small/img-3.jpg" alt="" height="230" width="200"
                      class="rounded object-fit-scale border">
                ...
                <BCol md="6" class="col-lg">
                  <div class="text-center">
                    <img src="@/assets/images/small/img-3.jpg" alt="" height="230" width="200"
                      class="rounded object-fit-none">
                    <p class="mt-2 mb-0"><code>.object-fit-none</code></p>
                  </div>
                </BCol>
              </BRow>
            </div>
            <div class="tab-pane" id="objectFitCode" role="tabpanel" aria-labelledby="objectFitCode-tab" tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
              <pre
                class="language-markup"><code>&lt;!-- Object Fit --&gt;
&lt;img src=&quot;##imagesPath##/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-cover&quot;&gt;</code>

<code>&lt;img src=&quot;##imagesPath##/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-contain&quot;&gt;</code>

<code>&lt;img src=&quot;##imagesPath##/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-fill&quot;&gt;</code>

<code>&lt;img src=&quot;##imagesPath##/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-scale&quot;&gt;</code>

<code>&lt;img src=&quot;##imagesPath##/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-none&quot;&gt;</code></pre>
            </div>
          </BCardBody>
        </BCard>
      </BCol>
    ...
    <BRow>
      <BCol xxl="12">
        <BCard no-body>
          <CardHeader title="Z-index" content="Use our low-level <code>z-index</code> utilities to quickly change the stack level of an element or component." />  
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="zIndexPreview" role="tabpanel" aria-labelledby="zIndexPreview-tab"
              tabindex="0">
            ...
            <div class="tab-pane" id="zIndexCode" role="tabpanel" aria-labelledby="zIndexCode-tab" tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
              <pre
                class="language-markup"><code>&lt;!-- z-index --&gt;
&lt;img src=&quot;##imagesPath##/users/avatar-1.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-n1&quot;&gt;</code>

<code>&lt;img src=&quot;##imagesPath##/users/avatar-2.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-0 ms-n5 mt-5&quot;&gt;</code>

<code>&lt;img src=&quot;##imagesPath##/users/avatar-3.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-1 ms-n5&quot;&gt;</code>

<code>&lt;img src=&quot;##imagesPath##/users/avatar-4.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-2 ms-n5 mt-5&quot;&gt;</code>

<code>&lt;img src=&quot;##imagesPath##/users/avatar-5.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-3 ms-n5&quot;&gt;</code></pre>
            </div>
          </BCardBody>
        </BCard>
      </BCol>
    ...
    <BRow>
      <BCol xxl="6">
        <BCard no-body>
          <CardHeader title="Text Selection" content="Use <code>user-select-all</code>, <code>user-select-auto</code>, or <code>user-select-none</code> class to the content which is selected when the user interacts with it." />  
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="textSelectionPreview" role="tabpanel"
              aria-labelledby="textSelectionPreview-tab" tabindex="0">
              <div>
            ...
            <div class="tab-pane" id="textSelectionCode" role="tabpanel" aria-labelledby="textSelectionCode-tab"
              tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
              <pre class="language-markup"
                style="height: 125px;"><code>&lt;!-- Text Selection --&gt;
...
<code>&lt;p class=&quot;user-select-none mb-0&quot;&gt;This paragraph will not be selectable when clicked by the user.&lt;/p&gt;</code></pre>
      ...
      <BCol xxl="6">
        <BCard no-body>
          <CardHeader title="Pointer Events" content="Use <code>pe-none</code> class to prevent and <code>pe-auto</code> class to add element interactions respectively." />  
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="pointerEventsPreview" role="tabpanel"
              aria-labelledby="pointerEventsPreview-tab" tabindex="0">
              <div>
                <p><BLink href="#" class="text-success pe-none" tabindex="-1">This link</BLink> can not be clicked.</p>
                <p><BLink href="#" class="text-success pe-auto">This link</BLink> can be clicked (this is default behavior).</p>
                <p class="pe-none mb-0"><BLink href="#" class="text-success" tabindex="-1">This link</BLink> can not be clicked
                  because the <code>pointer-events</code> property is inherited from its parent. However, <BLink href="#"
                    class="pe-auto">this link</BLink> has a <code>pe-auto</code> class and can be clicked.</p>
              </div>
            </div>
            <div class="tab-pane" id="pointerEventsCode" role="tabpanel" aria-labelledby="pointerEventsCode-tab"
              tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
              <pre
...
<code>&lt;p class=&quot;pe-none mb-0&quot;&gt;&lt;a href=&quot;#&quot; class=&quot;text-success&quot; tabindex=&quot;-1&quot; aria-disabled=&quot;true&quot;&gt;This link&lt;/a&gt; can not be clicked because the &lt;code&gt;pointer-events&lt;/code&gt; property is inherited from its parent. However, &lt;a href=&quot;#&quot; class=&quot;pe-auto&quot;&gt;this link&lt;/a&gt; has a &lt;code&gt;pe-auto&lt;/code&gt; class and can be clicked.&lt;/p&gt;</code></pre>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <CardHeader title="Overflow" content="Use <code>overflow</code> property on the fly with four default values and classes." />  
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="overflowPreview" role="tabpanel" aria-labelledby="overflowPreview-tab"
              tabindex="0">
              <div>
                <BRow>
                  <BCol xl="3" sm="6">
                    <div class="mt-4 mt-xl-0">
                      ...
                      <div class="d-md-flex bg-light">
                        <div class="overflow-auto p-3 mb-0 bg-light" style="height: 100px;">
                          ...
                          dimensions. By design, this content will vertically scroll. Lorem ipsum dolor sit amet,
                    ...
                    <div class="mt-4 mt-xl-0">
                      ...
                      <div class="d-md-flex bg-light">
                        <div class="overflow-hidden p-3 mb-0 bg-light" style="height: 100px;">
                          ...
                          height dimensions. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                    ...
                    <div class="mt-4 mt-xl-0">
                      ...
                      <div class="d-md-flex bg-light">
                        <div class="overflow-visible p-3 mb-0 bg-light" style="height: 100px;">
                          ...
                          height dimensions.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            ...
            <div class="tab-pane" id="overflowCode" role="tabpanel" aria-labelledby="overflowCode-tab" tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <CardHeader title="Position" content="Use below mentioned classes to arrange elements easily with the edge positioning utilities.The format is {property}-{position}." />  
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="positionPreview" role="tabpanel" aria-labelledby="positionPreview-tab"
              tabindex="0">
              <BRow>
                <BCol xl="4" sm="6">
                  <div>
            ...
            <div class="tab-pane" id="positionCode" role="tabpanel" aria-labelledby="positionCode-tab" tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <CardHeader title="Shadows" content="While shadows on components are disabled by default in Bootstrap and can be
          ...
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="shadowsPreview" role="tabpanel" aria-labelledby="shadowsPreview-tab"
              tabindex="0">
              <BRow class="gy-3">
                <BCol md="6">
                  <div class="shadow-none m-0 p-3 bg-light rounded">No shadow</div>
                </BCol>
                <BCol md="6">
            ...
            <div class="tab-pane" id="shadowsCode" role="tabpanel" aria-labelledby="shadowsCode-tab" tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
...
<code>&lt;div class=&quot;shadow-lg p-3 bg-light rounded&quot;&gt;Larger shadow&lt;/div&gt;</code></pre>
    ...
    <BRow>
      <BCol xxl="6">
        <BCard no-body>
          <CardHeader title="Width" content="Use <code>w-25</code>,<code>w-50</code>,<code>w-75</code>,<code>w-100</code> or
          ...
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="widthPreview" role="tabpanel" aria-labelledby="widthPreview-tab"
              tabindex="0">
            ...
            <div class="tab-pane" id="widthCode" role="tabpanel" aria-labelledby="widthCode-tab" tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
...
<code>&lt;div class=&quot;w-auto p-3 bg-light&quot;&gt;Width auto&lt;/div&gt;</code></pre>
      ...
      <BCol xxl="6">
        <BCard no-body>
          <CardHeader title="Height" content="Use <code>h-25</code>,<code>h-50</code>,<code>h-75</code>,<code>h-100</code> or <code>h-auto</code> class to set height <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, or <code>auto</code> by default respectively." />
          <BCardBody class="tab-content">
            <div class="tab-pane show active" id="heightPreview" role="tabpanel" aria-labelledby="heightPreview-tab"
              tabindex="0">
            ...
            <div class="tab-pane" id="heightCode" role="tabpanel" aria-labelledby="heightCode-tab" tabindex="0">
              <h5 class="fs-sm text-muted">HTML Preview</h5>
