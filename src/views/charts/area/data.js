...
const areaNegativeChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray('["--tb-success", "--tb-danger"]'),
    yaxis: {
      tickAmount: 4,
      floating: false,
...
const areaStackedChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray('["--tb-success", "--tb-info", "--tb-light"]'),
    dataLabels: {
      enabled: false,
    },
    stroke: {
...
const areaIrregularChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray('["--tb-primary", "--tb-warning", "--tb-success"]'),
  },
};
