...
const basicColumnChart = {
    ...
    chartOptions: {
        ...
        colors: getChartColorsArray('["--tb-danger", "--tb-primary", "--tb-success"]'),
        xaxis: {
            categories: [
                "Feb",
                "Mar",
...
const columnStackedChart = {
    ...
    chartOptions: {
        ...
        colors: getChartColorsArray('["--tb-primary", "--tb-success", "--tb-warning"]'),
    },
};
...
const columnMarkersChart = {
    ...
    chartOptions: {
        ...
        legend: {
            ...
            markers: {
                fillColors: getChartColorsArray('["--tb-success", "--tb-primary"]'),
            },
        },
    },
};
...
const chartNagetiveValuesColors = getChartColorsArray('["--tb-success", "--tb-danger", "--tb-warning"]');
const columnNegativeChart = {
    ...
    chartOptions: {
        // colors: chartNagetiveValuesColors,
        chart: {
            type: "bar",
            height: 350,
            toolbar: {
...
const colors = getChartColorsArray('["--tb-primary", "--tb-success", "--tb-warning", "--tb-danger", "--tb-dark", "--tb-info"]');
...
const groupedStackedChart = {
    ...
    chartOptions: {
        ...
        colors: getChartColorsArray('["--tb-primary", "--tb-success","--tb-secondary", "--tb-warning"]'),
        yaxis: {
            labels: {
                formatter: (val) => {
                    return val / 1000 + 'K';
    ...
    chartOptions: {
        ...
        plotOptions: {
            bar: {
                isDumbbell: true,
                columnWidth: 3,
                dumbbellColors: getChartColorsArray('["--tb-primary", "--tb-success"]'),
            }
        },
        legend: {
            show: true,
