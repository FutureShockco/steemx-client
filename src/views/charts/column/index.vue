    ...
    <Layout>
                    ...
                    <BCardBody>
                        <div id="dynamicloadedchart-wrap">
                            ...
                            <div id="chart-quarter">
                                <apexchart type="bar" height="330" ref="chartQuarter"
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle class="mb-0">Column with Group Label</BCardTitle>

                    </BCardHeader>
                    <BCardBody>
                        <apexchart type="bar" height="330" ref="chart" :options="columnGroupChart.chartOptions"
                            :series="columnGroupChart.series"></apexchart>
                    </BCardBody>
                </BCard>
            </BCol>
        </BRow>
