...
const multipleSeriesHeatmapChart = {
  ...
  chartOptions: {
    ...
    colors: getChartColorsArray('["--tb-primary", "--tb-secondary", "--tb-success", "--tb-info", "--tb-warning", "--tb-danger", "--tb-dark", "--tb-primary"]'),
    xaxis: {
      type: "category",
      categories: [
        "10:00",
...
const chartHeatMapColors = getChartColorsArray('["--tb-info", "--tb-success", "--tb-primary", "--tb-warning"]');
...
const chartHeatMapShadesColors = getChartColorsArray('["--tb-info", "--tb-primary"]');
