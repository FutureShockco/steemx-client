...
const dashedLineChart = {
  chartOptions: {
    ...
    colors: getChartColorsArray('["--tb-primary", "--tb-danger", "--tb-success"]'),
    dataLabels: {
      enabled: false,
    },
    stroke: {
...
var data = generateDayWiseTimeSeries(new Date('11 Feb 2017').getTime(), 60, {
  min: 30,
  max: 90
});
