...
const marketCapitalizationChart = {
    ...
    chartOptions: {
        ...
        colors: getChartColorsArray('["--tb-primary", "--tb-success", "--tb-warning","--tb-secondary", "--tb-danger"]'),
    }
};

// Allocation Overview
const allocationOverviewChart = {
    ...
    chartOptions: {
        ...
        colors: getChartColorsArray('["--tb-secondary", "--tb-primary", "--tb-danger","--tb-info", "--tb-warning"]')
    }
};

// Stock Market Gainers
const stockMarketGainersChart = {
    series: [{
        name: 'Monero (XMR) ',
        data: [{
...
export { marketCapitalizationChart, allocationOverviewChart, stockMarketGainersChart };