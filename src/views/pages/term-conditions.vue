            ...
            <BCard no-body class="overflow-hidden">
                <div class="bg-primary pb-0">
                    <BCardBody class="text-center py-4">
                        <h4 class="fw-medium text-white mb-3">SteemX Term & Conditions</h4>
                ...
                <BCardBody>
                    ...
                    <BCardTitle tag="h6" class="mb-3"><i class="bi bi-circle-square align-baseline me-1 text-info"></i> Governing Law & Jurisdiction</BCardTitle>
                    ...
                    <BCardTitle tag="h6" class="mb-3"><i class="bi bi-circle-square align-baseline me-1 text-info"></i> License</BCardTitle>
