            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Default Table"
                        content="Use <code>table</code> class to show bootstrap-based default table." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="defaultTablePreview" role="tabpanel"
                            aria-labelledby="defaultTablePreview-tab" tabindex="0">
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><BLink href="#" class="fw-medium">#VZ2110</BLink></th>
                                            <td>Bobby Davis</td>
                                            <td>October 15, 2021</td>
                                            <td>$2,300</td>
                                            <td><BLink href="javascript:void(0);" class="link-success">View More <i
                                                        class="ri-arrow-right-line align-middle"></i></BLink></td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><BLink href="#" class="fw-medium">#VZ2109</BLink></th>
                                        ...
                                        <tr>
                                            <th scope="row"><BLink href="#" class="fw-medium">#VZ2108</BLink></th>
                                            <td>Monkey Karry</td>
                                        ...
                                        <tr>
                                            <th scope="row"><BLink href="#" class="fw-medium">#VZ2107</BLink></th>
                                            <td>James White</td>
                        ...
                        <div class="tab-pane" id="defaultTableCode" role="tabpanel" aria-labelledby="defaultTableCode-tab"
                            tabindex="0">
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Striped Rows"
                        content="Use <code>table-striped</code> class to add zebra-striping to any table row within the tbody." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="stripedTablesPreview" role="tabpanel"
                            aria-labelledby="stripedTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                        ...
                        <div class="tab-pane" id="stripedTablesCode" role="tabpanel" aria-labelledby="stripedTablesCode-tab"
                            tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Striped columns"
                        content="Use .<code>table-striped-columns</code> to add zebra-striping to any table column." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="stripedColumnTablesPreview" role="tabpanel"
                            aria-labelledby="stripedColumnTablesPreview-tab" tabindex="0">
                                ...
                                <table class="table align-middle table-nowrap table-striped-columns mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VL2110</BLink></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VL2109</BLink></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VL2108</BLink></td>
                                            <td>Whitney Meier</td>
                                            <td>06 Oct, 2021</td>
                                            <td>$21.25</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VL2107</BLink></td>
                                            <td>Justin Maier</td>
                                            <td>05 Oct, 2021</td>
                                            <td>$25.03</td>
                                            <td><span class="badge bg-success">Paid</span></td>
                        ...
                        <div class="tab-pane" id="stripedColumnTablesCode" role="tabpanel"
                            aria-labelledby="stripedColumnTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/div&gt;</code></pre>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Tables Colors" content="Use <code>table-dark</code> class to set dark color table body and
                        <code>table-success</code> class to set success color table body respectively. use
                        <code>table-</code> class with different color variation to set required table body color." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="colorsTablesPreview" role="tabpanel"
                            aria-labelledby="colorsTablesPreview-tab" tabindex="0">
                            <BRow>
                                <BCol xl="6">
                                    <div class="table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="hstack gap-3 flex-wrap">
                                                            <BLink href="javascript:void(0);" class="link-success fs-base"><i
                                                                    class="ri-edit-2-line"></i></BLink>
                                                            <BLink href="javascript:void(0);" class="link-danger fs-base"><i
                        ...
                        <div class="tab-pane" id="colorsTablesCode" role="tabpanel" aria-labelledby="colorsTablesCode-tab"
                            tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
            ...
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Hoverable Rows"
                        content="Use <code>table-hover</code> class to enable a hover state on table rows within a tbody." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="hoverableTablesPreview" role="tabpanel"
                            aria-labelledby="hoverableTablesPreview-tab" tabindex="0">
                            <BRow>
                                <BCol xl="6">
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Cleo Carson</td>
                                                    <td>$4,521</td>
                                                    <td><BLink href="javascript:void(0);"><i
                                                                class="ri-download-2-line fs-xl lh-1 align-middle"></i></BLink>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">
                        ...
                        <div class="tab-pane" id="hoverableTablesCode" role="tabpanel"
                            aria-labelledby="hoverableTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Card Tables"
                        content="Use <code>table-card</code> class to show card-based table within a tbody." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="cardTablesPreview" role="tabpanel"
                            aria-labelledby="cardTablesPreview-tab" tabindex="0">
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                        ...
                        <div class="tab-pane" id="cardTablesCode" role="tabpanel" aria-labelledby="cardTablesCode-tab"
                            tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
                            <pre class="language-markup" style="height: 275px;"><code>&lt;div class=&quot;table-responsive table-card&quot;&gt;
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Active Tables"
                        content="Use <code>table-active</code> class to highlight a table row or cell." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="ActiveTablesPreview" role="tabpanel"
                            aria-labelledby="ActiveTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap mb-0">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$4,521</td>
                                            <td><BLink href="javascript:void(0);"><i
                                                        class="ri-download-2-line fs-xl lh-1 align-middle"></i></BLink></td>
                                        </tr>
                        ...
                        <div class="tab-pane" id="ActiveTablesCode" role="tabpanel" aria-labelledby="ActiveTablesCode-tab"
                            tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/table&gt;</code></pre>
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Bordered Tables" content="Use <code>table-bordered</code> class to show borders on all sides of
                        the table and cells." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="borderedTablesPreview" role="tabpanel"
                            aria-labelledby="borderedTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$4,521</td>
                                            <td>
                                                <BDropdown variant="link" toggle-class="arrow-none">
                                        ...
                                        <tr>
                                            <td class="fw-medium">02</td>
                                            <td>Design syntax</td>
                                            <td><span class="badge bg-secondary-subtle text-secondary">In Progress</span>
                                            </td>
                        ...
                        <div class="tab-pane" id="borderedTablesCode" role="tabpanel"
                            aria-labelledby="borderedTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/table&gt;</code></pre>
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Tables Border Colors" content="Use <code>border-</code> class with color variation class to set
                        table border color." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="borderColorsTablesPreview" role="tabpanel"
                            aria-labelledby="borderColorsTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                        ...
                        <div class="tab-pane" id="borderColorsTablesCode" role="tabpanel"
                            aria-labelledby="borderColorsTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Tables Without Borders"
                        content="Use <code>table-borderless</code> to set a table without borders." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="withoutBordersTablesPreview" role="tabpanel"
                            aria-labelledby="withoutBordersTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                        ...
                        <div class="tab-pane" id="withoutBordersTablesCode" role="tabpanel"
                            aria-labelledby="withoutBordersTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/table&gt;</code></pre>
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Small Tables" content="Use <code>table-sm</code> class to create any table more compact by
                        cutting all cell padding in half." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="smallTablesPreview" role="tabpanel"
                            aria-labelledby="smallTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                        ...
                        <div class="tab-pane" id="smallTablesCode" role="tabpanel" aria-labelledby="smallTablesCode-tab"
                            tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Table Head"
                        content="Use <code>table-light</code> or <code>table-dark</code> class to create thead appear light or dark." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="headTablesPreview" role="tabpanel"
                            aria-labelledby="headTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><BLink href="javascript:void(0);" class="link-success">Confirmed</BLink></td>
                                        </tr>
                                        <tr>
                                            <td>Jassica Welsh</td>
                                            <td>3d Animation</td>
                                            ...
                                            <td><BLink href="javascript:void(0);" class="link-warning">Waiting</BLink></td>
                                        </tr>
                                        <tr>
                                            <td>Leslie Alexander</td>
                        ...
                        <div class="tab-pane" id="headTablesCode" role="tabpanel" aria-labelledby="headTablesCode-tab"
                            tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Table Foot"
                        content="Add <code>tbody</code> attribute to group footer content in an HTML table" />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="footTablesPreview" role="tabpanel"
                            aria-labelledby="footTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                                <table class="table table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                        ...
                        <div class="tab-pane" id="footTablesCode" role="tabpanel" aria-labelledby="footTablesCode-tab"
                            tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Captions"
                        content="You can also put the <code>&lt;caption&gt;</code> attribute on the top of the table with <code>caption-top</code> class." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="captionsTablesPreview" role="tabpanel"
                            aria-labelledby="captionsTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                        ...
                        <div class="tab-pane" id="captionsTablesCode" role="tabpanel"
                            aria-labelledby="captionsTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/table&gt;</code></pre>
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Table Nesting" content="Example of basic table nesting. Border styles, active styles, and
                    table variants are not inherited by nested tables." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="nestingTablesPreview" role="tabpanel"
                            aria-labelledby="nestingTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                                <table class="table table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                        ...
                        <div class="tab-pane" id="nestingTablesCode" role="tabpanel" aria-labelledby="nestingTablesCode-tab"
                            tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
            ...
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Variants"
                        content="Use <code>table-</code> class with below-mentioned color variation class within tr to set color on table row" />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="variantsTablesPreview" role="tabpanel"
                            aria-labelledby="variantsTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                                <table class="table table-nowrap mb-0">
                                    <thead>
                                        <tr>
                        ...
                        <div class="tab-pane" id="variantsTablesCode" role="tabpanel"
                            aria-labelledby="variantsTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/table&gt;</code></pre>
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Vertical alignment" content="Table cells of <code>&lt;thead&gt;</code> are always vertical aligned
                        to the bottom. Table cells in <code>&lt;tbody&gt;</code> inherit their alignment from
                        <code>&lt;table&gt;</code> and are aligned to the the top by default. Use the vertical align
                        classes to re-align where needed." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="verticalAlignmentTablesPreview" role="tabpanel"
                            aria-labelledby="verticalAlignmentTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                        ...
                        <div class="tab-pane" id="verticalAlignmentTablesCode" role="tabpanel"
                            aria-labelledby="verticalAlignmentTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
...
&lt;/div&gt;</code></pre>
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Responsive Tables" content="Use <code>table-responsive</code> class to make any table responsive
                        across all viewports. Responsive tables allow tables to be scrolled horizontally with ease." />
                    <BCardBody class="tab-content">
                        <div class="tab-pane show active" id="responsiveTablesPreview" role="tabpanel"
                            aria-labelledby="responsiveTablesPreview-tab" tabindex="0">
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VZ2110</BLink></td>
                                            <td>10 Oct, 14:47</td>
                                            <td class="text-success"><i
                                                    class="ri-checkbox-circle-line fs-xl align-middle"></i> Paid</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VZ2109</BLink></td>
                                            <td>17 Oct, 02:10</td>
                                            <td class="text-success"><i
                                                    class="ri-checkbox-circle-line fs-xl align-middle"></i> Paid</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VZ2108</BLink></td>
                                            <td>26 Oct, 08:20</td>
                                            <td class="text-primary"><i class="ri-refresh-line fs-xl align-middle"></i>
                                                Refunded</td>
                                            <td>
                                                <div class="d-flex gap-2 align-items-center">
                                                    <div class="flex-shrink-0">
                                        ...
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VZ2107</BLink></td>
                                            <td>02 Nov, 04:52</td>
                                            <td class="text-danger"><i class="ri-close-circle-line fs-xl align-middle"></i>
                                                Cancel</td>
                                            <td>
                                                <div class="d-flex gap-2 align-items-center">
                                                    <div class="flex-shrink-0">
                                        ...
                                        <tr>
                                            ...
                                            <td><BLink href="#" class="fw-medium">#VZ2106</BLink></td>
                                            <td>10 Nov, 07:20</td>
                                            <td class="text-success"><i
                                                    class="ri-checkbox-circle-line fs-xl align-middle"></i> Paid</td>
                                            <td>
                        ...
                        <div class="tab-pane" id="responsiveTablesCode" role="tabpanel"
                            aria-labelledby="responsiveTablesCode-tab" tabindex="0">
                            <h5 class="fs-sm text-muted">HTML Preview</h5>
